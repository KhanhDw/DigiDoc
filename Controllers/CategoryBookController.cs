...
namespace WebApplication1.Controllers
{
    public class CategoryBookController(ApplicationDbContext context) : Controller
    {
        ...
        // [HttpGet(")]
        [Route("/CategoryBook/tat-ca/trang/{page?}")]

        public async Task<IActionResult> Index(int? page)
        {
            ViewBag.danhmucLink = "tat-ca";
        ...
        [Route("CategoryBook/{danhmuc}/trang/{page?}")]
        public IActionResult Index(string danhmuc, int? page)
        {
            var username = User.Identity?.Name;
            ViewBag.UserName = username;
            ViewBag.DiemTieuTaiFile = 0;
            ...
            if (danhmuc == "ban-hang-va-kinh-doanh")
            {
                ...
                ViewBag.danhmucLink = "ban-hang-va-kinh-doanh";
                //return View(books1);
            }
            else if (danhmuc == "phat-trien-ban-than")
            {
                ...
                books1 = GetBookBySubject(ViewBag.danhmuc);
                ViewBag.danhmucLink = "phat-trien-ban-than";
                //return View(books1);
            }
            else if (danhmuc == "IT-va-lap-trinh")
            {
                ...
                books1 = GetBookBySubject(ViewBag.danhmuc);
                ViewBag.danhmucLink = "IT-va-lap-trinh";
                //return View(books1);
            }
            else if (danhmuc == "ke-toan-thue-tai-chinh")
            {
                ...
                books1 = GetBookBySubject(ViewBag.danhmuc);
                ViewBag.danhmucLink = "ke-toan-thue-tai-chinh";
                //return View(books1);
            }
            else if (danhmuc == "kien-truc-va-xay-dung")
            {
                ...
                books1 = GetBookBySubject(ViewBag.danhmuc);
                ViewBag.danhmucLink = "kien-truc-va-xay-dung";
                //return View(books1);
            }
            else if (danhmuc == "luat-phap-ly")
            {
                ...
                books1 = GetBookBySubject(ViewBag.danhmuc);
                ViewBag.danhmucLink = "luat-phap-ly";
                //return View(books1);
            }
            else if (danhmuc == "Marketing-truyen-thong")
            {
                ...
                books1 = GetBookBySubject(ViewBag.danhmuc);
                ViewBag.danhmucLink = "Marketing-truyen-thong";
                //return View(books1);
            }
